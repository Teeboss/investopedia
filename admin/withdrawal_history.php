                 ...
                 <div id="loader">
                  ...
                  $pagination_to = $item * $page;
                   ...
                   /* ---------- pagination logic ends here -----------*/
                    ...
                    $items =  DB::query("SELECT * FROM withdrawal_history  ORDER BY id DESC " ,  array());
                    $nums = count($items);
                ...
                <?php
                  ...
                  if ($pagination_from == 1) {
                    $pagination_from = $page + 1;
                      echo "<div class ='pagination w-75 p-3'><a href='deposit_history.php?item=10&page=".$pagination_from."'><button class = 'next_button'>Next</button></a></div>"." ";
                     } else if ($pagination_from <  $total) {
                    $pagination_from = $page + 1;
                    $mfrom = $page - 1;
                      echo "<div class='pagination w-75 p-3'><a href='deposit_history.php?item=10&page=".$mfrom."'><button class = 'next_button'>Previous</button></a>"." "."<a href='deposit_history.php?item=10&page=".$pagination_from."'><button class = 'next_button'>Next</button></a></div>"." " ;
                     } else if ( $item >= $total ) {
                     $mfrom = $page - 1;
                     echo  "<div class='pagination w-75 p-3'><a href='deposit_history.php?item=10&page=".$mfrom."'><button class = 'next_button'>Previous</button></a></div>" ;
                     } 
